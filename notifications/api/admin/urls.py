...
urlpatterns = [
    ...
    path("notificacion-anuncio/estado/", NotificacionAnuncioDetalleAdminView.as_view()),
    path("notificacion-anuncio/envio/", NotificacionAnuncioDetalleAdminView.as_view()),
